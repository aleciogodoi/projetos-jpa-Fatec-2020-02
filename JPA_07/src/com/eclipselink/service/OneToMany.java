...
public class OneToMany {
	public static void main(String[] args) {
		...
		List<Funcionario> funcionarios03 = new ArrayList();
		funcionarios03.add(func01);
		funcionarios03.add(func02);
		funcionarios03.add(func03);
		funcionarios03.add(func04);
		funcionarios03.add(func05);
		funcionarios03.add(func06);
		...
		Departamento depto04 = new Departamento(4, "Geral", funcionarios03);
