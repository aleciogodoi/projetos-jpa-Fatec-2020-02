...
public class CriteriaApi {
	...
	public static void main(String[] args) {
		...
		select2.where(criteriaBuilder.equal(from.get("idPessoa"), 1));
		...
		select3.where(criteriaBuilder.like(from.get("nome"), "%p%"));
		...
		select4.where(criteriaBuilder.in(from.get("idPessoa")).value(1).value(5).value(7).value(4));
