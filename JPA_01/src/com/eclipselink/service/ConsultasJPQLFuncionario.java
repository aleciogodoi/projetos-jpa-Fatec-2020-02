...
public class ConsultasJPQLFuncionario {
	...
	public static void main(String[] args) {
		...
		Query query4 = entitymanager.createQuery("Select f from Funcionario f "
											    + "Where f.salario Between :salarioIni and :salarioFim "
											    + " and f.nome like '%o%'"
											    + "Order by f.salario desc");
		
		query4.setParameter("salarioIni", 4000);
		query4.setParameter("salarioFim", 15000);
